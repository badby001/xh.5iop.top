        ...
        <div class="layui-card-body">
            ...
            <form class="layui-form toolbar table-tool-mini">
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        <div class="layui-card-header1" data-step="1" data-intro="您好! 这是时间类型的筛选, 默认有 下单时间 的选项"
                    ...
                    <div class="layui-inline">
                        <div class="layui-card-header1" data-step="3" data-intro="您好! 请在文本框内输入您要搜索内容的关键字"
                            ...
                            <div class="layui-input-inline">
                                <input type="text" class="layui-input" placeholder="请输入关键字 | 商品名称" autocomplete="off"
                                       name="key">
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    layui.use(["admin", "jquery", "table", "form", "laydate", "okLayer", "okUtils", "introJs"], function () {
        ...
        let orderTable = table.render({
            elem: "#tableId",
            url: '{{url('/sys/pages/order/order1Read')}}',
            limit: '{!! frame()['limit'] !!}',
            limits: [{!! frame()['limits'] !!}],
            ...
            cols: [[
                ...
                {field: "lineTitle", title: "商品名称", width: 220},
                    @if(_admIsVip()==1)
                {
                ...
                {field: "noPingAmount_show", title: "未付总额", width: 135, sort: true, align: 'right'},
                    @endif
                {field: "priceTitle", title: "商品规格", width: 100},
                {field: "perNum", title: "数量", width: 100, sort: true, totalRow: true},
                ...
                {field: "endTime", title: "支付终止时间", width: 180, sort: true},
                {
                    title: "操作", width: 100, align: "center", fixed: "right", templet: function (d) {
                        var orderInfo = "@if(hasPower(286))<a href=\"javascript:\" title=\"订单详情\" lay-event=\"orderInfo\"><i class=\"ok-icon\">&#xe74a;</i></a>@endif";
                        var pay = "<a href=\"javascript:\" title=\"支付\" lay-event=\"pay\"><i class=\"ok-icon\">&#xe77d;</i></a>";
                        var cancel = "@if(hasPower(287))<a href=\"javascript:\" title=\"取消\" lay-event=\"cancel\"><i class=\"ok-icon\">&#xe659;</i></a>@endif";
                        var list = '';
        ...
        function log(id) {
            ...
            var tableId = id;
            var tableStr = 'ctName,ctInfo,ordBak,saleName,sources';
